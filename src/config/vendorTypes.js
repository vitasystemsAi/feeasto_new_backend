...
const VENDOR_TYPES = [
  {
    ...
    orderingConfig: {
      ...
      portionOptions: ["Half", "Full", "Piece"],
      orderFlow: ["Items", "Quantity", "Plate / Piece", "Order"],
      unitLabel: "per plate",
    },
  },
  {
    ...
    orderingConfig: {
      orderingMode: "weight",
      defaultUnit: "kg",
      allowedUnits: ["kg", "g", "500g", "250g", "piece"],
      portionOptions: ["250 g", "500 g", "1 kg", "2 kg"],
      orderFlow: ["Items", "Weight (kg / g) or Piece", "Quantity", "Order"],
  ...
  },
  {
    ...
    orderingConfig: {
      orderingMode: "weight",
      defaultUnit: "kg",
      allowedUnits: ["kg", "g", "500g", "250g", "bunch", "piece"],
  ...
  },
  {
    ...
    orderingConfig: {
      orderingMode: "weight",
      defaultUnit: "kg",
      allowedUnits: ["kg", "g", "500g", "dozen", "piece"],
  ...
  },
  {
    ...
    orderingConfig: {
      orderingMode: "weight",
      defaultUnit: "250g",
      allowedUnits: ["kg", "g", "250g", "500g", "piece", "box"],
      portionOptions: ["250 g", "500 g", "1 kg", "Box"],
      orderFlow: ["Products", "kg / g / Piece", "Quantity", "Order"],
  ...
  },
  {
    ...
    orderingConfig: {
      orderingMode: "volume",
      defaultUnit: "litre",
      allowedUnits: ["litre", "ml", "500ml", "250ml", "packet", "piece", "kg"],
  ...
  },
  {
    ...
    orderingConfig: {
      ...
      orderFlow: ["Drinks", "Quantity", "Size", "Order"],
  ...
  },
  {
    ...
    orderingConfig: {
      ...
      orderFlow: ["Items", "Quantity", "Size / Cup", "Order"],
