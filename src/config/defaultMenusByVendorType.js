    ...
    categories: [
      {
        name: "Fresh Chicken",
        items: [
          { name: "Chicken Whole", price: 220, isVeg: false, description: "Per kg" },
          { name: "Chicken Curry Cut", price: 230, isVeg: false, description: "Per kg" },
          { name: "Chicken Breast Boneless", price: 320, isVeg: false, description: "Per kg" },
          { name: "Chicken Legs", price: 280, isVeg: false, description: "Per kg" },
          { name: "Chicken Wings", price: 260, isVeg: false, description: "Per kg" },
        ],
      },
      {
        name: "Specialty Cuts",
        items: [
          { name: "Chicken Mince (Keema)", price: 300, isVeg: false, description: "Per kg" },
          { name: "Chicken Liver", price: 180, isVeg: false, description: "Per kg" },
          { name: "Chicken Gizzard", price: 160, isVeg: false, description: "Per kg" },
        ],
      },
      {
        name: "Marinated",
        items: [
          { name: "Tandoori Marinated Chicken", price: 280, isVeg: false, description: "Per kg" },
          { name: "Biryani Cut Marinated", price: 250, isVeg: false, description: "Per kg" },
        ],
      },
    ],
  },
    ...
    categories: [
      {
        name: "Fresh Mutton",
        items: [
          { name: "Mutton Curry Cut", price: 750, isVeg: false, description: "Per kg" },
          { name: "Mutton Boneless", price: 900, isVeg: false, description: "Per kg" },
          { name: "Mutton Chops", price: 850, isVeg: false, description: "Per kg" },
          { name: "Mutton Leg", price: 780, isVeg: false, description: "Per kg" },
        ],
      },
      {
        name: "Specialty",
        items: [
          { name: "Mutton Keema", price: 820, isVeg: false, description: "Per kg" },
          { name: "Mutton Liver", price: 400, isVeg: false, description: "Per kg" },
          { name: "Mutton Paya", price: 350, isVeg: false, description: "Per set" },
        ],
      },
    ],
  },
    ...
    categories: [
      {
        name: "Fresh Fish",
        items: [
          { name: "Rohu", price: 280, isVeg: false, description: "Per kg" },
          { name: "Katla", price: 300, isVeg: false, description: "Per kg" },
          { name: "Pomfret", price: 650, isVeg: false, description: "Per kg" },
          { name: "Seer Fish (Surmai)", price: 700, isVeg: false, description: "Per kg" },
          { name: "Bangda (Mackerel)", price: 220, isVeg: false, description: "Per kg" },
        ],
      },
      {
        name: "Seafood",
        items: [
          { name: "Prawns", price: 550, isVeg: false, description: "Per kg" },
          { name: "Crab", price: 400, isVeg: false, description: "Per kg" },
          { name: "Squid", price: 380, isVeg: false, description: "Per kg" },
        ],
      },
      {
        name: "Cut & Clean",
        items: [
          { name: "Fish Curry Cut", price: 320, isVeg: false, description: "Per kg" },
          { name: "Fish Fillet", price: 450, isVeg: false, description: "Per kg" },
        ],
      },
    ],
  },
    ...
    categories: [
      {
        name: "Leafy Greens",
        items: [
          { name: "Spinach (Palak)", price: 30, isVeg: true, description: "Per bunch" },
          { name: "Coriander", price: 15, isVeg: true, description: "Per bunch" },
          { name: "Methi", price: 25, isVeg: true, description: "Per bunch" },
          { name: "Mint (Pudina)", price: 15, isVeg: true, description: "Per bunch" },
        ],
      },
      {
        name: "Everyday Vegetables",
        items: [
          { name: "Tomato", price: 40, isVeg: true, description: "Per kg" },
          { name: "Onion", price: 35, isVeg: true, description: "Per kg" },
          { name: "Potato", price: 30, isVeg: true, description: "Per kg" },
          { name: "Green Chilli", price: 60, isVeg: true, description: "Per kg" },
          { name: "Capsicum", price: 70, isVeg: true, description: "Per kg" },
          { name: "Carrot", price: 50, isVeg: true, description: "Per kg" },
          { name: "Cabbage", price: 35, isVeg: true, description: "Per kg" },
          { name: "Cauliflower", price: 40, isVeg: true, description: "Per piece" },
        ],
      },
      {
        name: "Beans & Others",
        items: [
          { name: "Green Beans", price: 60, isVeg: true, description: "Per kg" },
          { name: "Brinjal", price: 45, isVeg: true, description: "Per kg" },
          { name: "Okra (Bhindi)", price: 55, isVeg: true, description: "Per kg" },
          { name: "Bottle Gourd", price: 35, isVeg: true, description: "Per kg" },
        ],
      },
    ],
  },
    ...
    categories: [
      {
        ...
        items: [
          { name: "Banana", price: 50, isVeg: true, description: "Per dozen" },
          { name: "Apple", price: 180, isVeg: true, description: "Per kg" },
          { name: "Orange", price: 80, isVeg: true, description: "Per kg" },
          { name: "Mango", price: 120, isVeg: true, description: "Per kg" },
          { name: "Grapes", price: 100, isVeg: true, description: "Per kg" },
        ],
      },
      {
        name: "Everyday Fruits",
        items: [
          { name: "Papaya", price: 40, isVeg: true, description: "Per kg" },
          { name: "Watermelon", price: 25, isVeg: true, description: "Per kg" },
          { name: "Pomegranate", price: 160, isVeg: true, description: "Per kg" },
          { name: "Guava", price: 60, isVeg: true, description: "Per kg" },
          { name: "Mosambi", price: 70, isVeg: true, description: "Per kg" },
        ],
      },
    ],
  },
    ...
    categories: [
      {
        name: "Milk Sweets",
        items: [
          { name: "Gulab Jamun", price: 320, isVeg: true, description: "Per kg" },
          { name: "Rasgulla", price: 280, isVeg: true, description: "Per kg" },
          { name: "Kalakand", price: 400, isVeg: true, description: "Per kg" },
          { name: "Milk Cake", price: 380, isVeg: true, description: "Per kg" },
        ],
      },
      {
        name: "Traditional",
        items: [
          { name: "Laddu", price: 300, isVeg: true, description: "Per kg" },
          { name: "Jalebi", price: 250, isVeg: true, description: "Per kg" },
          { name: "Mysore Pak", price: 450, isVeg: true, description: "Per kg" },
          { name: "Barfi", price: 420, isVeg: true, description: "Per kg" },
        ],
      },
      {
        name: "Special Boxes",
